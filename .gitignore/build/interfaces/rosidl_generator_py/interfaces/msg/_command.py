...
class Command(metaclass=Metaclass_Command):
    ...
    def __init__(self, **kwargs):
        ...
        self.x_cmd = kwargs.get('x_cmd', float())
        self.y_cmd = kwargs.get('y_cmd', float())
    ...
    def x_cmd(self, value):
        if __debug__:
            assert \
                ...
                "The 'x_cmd' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'x_cmd' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._x_cmd = value
    ...
    def y_cmd(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'y_cmd' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'y_cmd' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._y_cmd = value
