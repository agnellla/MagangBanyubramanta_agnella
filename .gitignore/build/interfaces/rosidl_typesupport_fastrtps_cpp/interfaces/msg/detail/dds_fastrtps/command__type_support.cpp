...
#include "interfaces/msg/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Command & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Command & ros_message)
{
  // Member: x_cmd
  cdr >> ros_message.x_cmd;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::Command;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Command *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Command *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Command__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Command)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Command__handle;
}
