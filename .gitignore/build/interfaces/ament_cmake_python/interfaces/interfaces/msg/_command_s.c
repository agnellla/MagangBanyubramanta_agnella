...
bool interfaces__msg__command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._command.Command", full_classname_dest, 31) == 0);
  }
  interfaces__msg__Command * ros_message = _ros_message;
  {  // x_cmd
    ...
    ros_message->x_cmd = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // y_cmd
    ...
    assert(PyFloat_Check(field));
    ros_message->y_cmd = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // yaw
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * interfaces__msg__command__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Command */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._command");
  ...
  interfaces__msg__Command * ros_message = (interfaces__msg__Command *)raw_ros_message;
  {  // x_cmd
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->x_cmd);
    {
  ...
  {  // y_cmd
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->y_cmd);
    {
